...
export class ProductsComponent {
  ...
  digits =/^[0-9\+\-\ ]*$/;
    ...
    stock: new FormControl('', [ Validators.required, Validators.pattern(this.digits)]),
    total_sale: new FormControl('',[ Validators.required, Validators.pattern(this.digits)]),
    altert_qnty: new FormControl('', [ Validators.required, Validators.pattern(this.digits)]),
